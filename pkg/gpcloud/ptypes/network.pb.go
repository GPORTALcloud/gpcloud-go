...
type Switch struct {
	...
	Type             SwitchType             `protobuf:"varint,3,opt,name=type,proto3,enum=api.network.SwitchType" json:"type,omitempty"`
	...
	ServerInterfaces []*ServerInterface     `protobuf:"bytes,8,rep,name=server_interfaces,json=serverInterfaces,proto3" json:"server_interfaces,omitempty"`
	UplinkPorts      []string               `protobuf:"bytes,9,rep,name=uplink_ports,json=uplinkPorts,proto3" json:"uplink_ports,omitempty"`
	CreatedAt        *timestamppb.Timestamp `protobuf:"bytes,10,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	UpdatedAt        *timestamppb.Timestamp `protobuf:"bytes,11,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"`
	LastArpSync      *timestamppb.Timestamp `protobuf:"bytes,12,opt,name=last_arp_sync,json=lastArpSync,proto3" json:"last_arp_sync,omitempty"`
}
...
type DHCPNetworksRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Datacenter  *DataCenter `protobuf:"bytes,1,opt,name=datacenter,proto3" json:"datacenter,omitempty"`
	NetworkType NetworkType `protobuf:"varint,2,opt,name=network_type,json=networkType,proto3,enum=api.network.NetworkType" json:"network_type,omitempty"`
}

func (x *DHCPNetworksRequest) Reset() {
	*x = DHCPNetworksRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *DHCPNetworksRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DHCPNetworksRequest) ProtoMessage() {}

func (x *DHCPNetworksRequest) ProtoReflect() protoreflect.Message {
	mi := &file_network_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DHCPNetworksRequest.ProtoReflect.Descriptor instead.
func (*DHCPNetworksRequest) Descriptor() ([]byte, []int) {
	return file_network_proto_rawDescGZIP(), []int{5}
}

func (x *DHCPNetworksRequest) GetDatacenter() *DataCenter {
	if x != nil {
		return x.Datacenter
	}
	return nil
...
func (x *DHCPNetworksRequest) GetNetworkType() NetworkType {
	if x != nil {
...
type DHCPNetwork struct {
	...
	Network *Cidr `protobuf:"bytes,1,opt,name=network,proto3" json:"network,omitempty"`
}

func (x *DHCPNetwork) Reset() {
	*x = DHCPNetwork{}
	if protoimpl.UnsafeEnabled {
...
func (x *DHCPNetwork) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DHCPNetwork) ProtoMessage() {}

func (x *DHCPNetwork) ProtoReflect() protoreflect.Message {
	mi := &file_network_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DHCPNetwork.ProtoReflect.Descriptor instead.
func (*DHCPNetwork) Descriptor() ([]byte, []int) {
	return file_network_proto_rawDescGZIP(), []int{8}
}

func (x *DHCPNetwork) GetNetwork() *Cidr {
	if x != nil {
		return x.Network
	}
	return nil
...
type DHCPNetworksResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Subnets    []*Subnet       `protobuf:"bytes,1,rep,name=subnets,proto3" json:"subnets,omitempty"`
	Mapping    []*MacIPMapping `protobuf:"bytes,2,rep,name=mapping,proto3" json:"mapping,omitempty"`
...
func (x *DHCPNetworksResponse) Reset() {
	*x = DHCPNetworksResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *DHCPNetworksResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DHCPNetworksResponse) ProtoMessage() {}

func (x *DHCPNetworksResponse) ProtoReflect() protoreflect.Message {
	mi := &file_network_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DHCPNetworksResponse.ProtoReflect.Descriptor instead.
func (*DHCPNetworksResponse) Descriptor() ([]byte, []int) {
	return file_network_proto_rawDescGZIP(), []int{9}
}

func (x *DHCPNetworksResponse) GetSubnets() []*Subnet {
	if x != nil {
		return x.Subnets
	}
	return nil
...
func (x *DHCPNetworksResponse) GetMapping() []*MacIPMapping {
	if x != nil {
		return x.Mapping
	}
	return nil
...
func (x *DHCPNetworksResponse) GetDnsServers() []string {
	if x != nil {
		return x.DnsServers
	}
	return nil
...
func (x *DHCPNetworksResponse) GetNtpServers() []string {
	if x != nil {
		return x.NtpServers
	}
	return nil
...
type AdminUpdateSwitchRequest struct {
	...
	Username     string     `protobuf:"bytes,6,opt,name=username,proto3" json:"username,omitempty"`
	Password     string     `protobuf:"bytes,7,opt,name=password,proto3" json:"password,omitempty"`
	UplinkPorts  []string   `protobuf:"bytes,8,rep,name=uplink_ports,json=uplinkPorts,proto3" json:"uplink_ports,omitempty"`
}
...
func (x *AdminUpdateSwitchRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *AdminUpdateSwitchRequest) GetType() SwitchType {
	if x != nil {
		return x.Type
	}
	return SwitchType_Juniper
...
func (x *AdminUpdateSwitchRequest) GetIp() string {
	if x != nil {
		return x.Ip
	}
	return ""
...
var file_network_proto_rawDesc = []byte{
	...
	0x0b, 0x61, 0x70, 0x69, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x1a, 0x1f, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x74, 0x69,
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0c, 0x72,
	0x65, 0x67, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0b, 0x62, 0x61, 0x73,
	0x69, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xfd, 0x03, 0x0a, 0x06, 0x53, 0x77, 0x69,
	...
	0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x6e, 0x65, 0x74, 0x77,
	0x6f, 0x72, 0x6b, 0x2e, 0x53, 0x77, 0x69, 0x74, 0x63, 0x68, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04,
	0x74, 0x79, 0x70, 0x65, 0x12, 0x36, 0x0a, 0x0a, 0x64, 0x61, 0x74, 0x61, 0x63, 0x65, 0x6e, 0x74,
	0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x72,
	0x65, 0x67, 0x69, 0x6f, 0x6e, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x43, 0x65, 0x6e, 0x74, 0x65, 0x72,
	0x52, 0x0a, 0x64, 0x61, 0x74, 0x61, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x77, 0x6f, 0x72, 0x64, 0x12, 0x49, 0x0a, 0x11, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x69,
	0x6e, 0x74, 0x65, 0x72, 0x66, 0x61, 0x63, 0x65, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x1c, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2e, 0x53, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x66, 0x61, 0x63, 0x65, 0x52, 0x10, 0x73,
	...
	0x09, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0b, 0x75, 0x70, 0x6c, 0x69, 0x6e, 0x6b, 0x50, 0x6f, 0x72,
	...
	0x5f, 0x61, 0x72, 0x70, 0x5f, 0x73, 0x79, 0x6e, 0x63, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75,
	0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x0b, 0x6c, 0x61, 0x73,
	0x74, 0x41, 0x72, 0x70, 0x53, 0x79, 0x6e, 0x63, 0x22, 0xc8, 0x03, 0x0a, 0x07, 0x4e, 0x65, 0x74,
	...
	,
	...
	0x64, 0x41, 0x74, 0x22, 0xd9, 0x02, 0x0a, 0x06, 0x53, 0x75, 0x62, 0x6e, 0x65, 0x74, 0x12, 0x0e,
	...
	,
	...
	0x72, 0x65, 0x73, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x18, 0x04,
	...
	,
	...
	0x0a, 0x13, 0x44, 0x48, 0x43, 0x50, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x36, 0x0a, 0x0a, 0x64, 0x61, 0x74, 0x61, 0x63, 0x65, 0x6e,
	0x74, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x43, 0x65, 0x6e, 0x74, 0x65,
	0x72, 0x52, 0x0a, 0x64, 0x61, 0x74, 0x61, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x12, 0x3b, 0x0a,
	...
	,
	...
	,
	...
	0x70, 0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1a, 0x0a,
	0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x75, 0x70, 0x6c,
	0x69, 0x6e, 0x6b, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x0b, 0x75, 0x70, 0x6c, 0x69, 0x6e, 0x6b, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x22, 0xfb, 0x01, 0x0a,
	0x18, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x77, 0x69, 0x74,
	...
	0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x61, 0x70,
	...
	0x74, 0x61, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28,
	...
	,
	...
	0x9b, 0x01, 0x0a, 0x19, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4e,
	...
	0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x76, 0x6c, 0x61, 0x6e, 0x49, 0x64, 0x22, 0x58, 0x0a,
	0x19, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4e, 0x65, 0x74, 0x77,
	...
	0x06, 0x76, 0x6c, 0x61, 0x6e, 0x49, 0x64, 0x22, 0xb5, 0x01, 0x0a, 0x18, 0x41, 0x64, 0x6d, 0x69,
	0x6e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x75, 0x62, 0x6e, 0x65, 0x74, 0x52, 0x65, 0x71,
	...
	,
	...
	0x64, 0x22, 0x4d, 0x0a, 0x04, 0x56, 0x4c, 0x41, 0x4e, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x76, 0x6c, 0x61,
	0x6e, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x76, 0x6c, 0x61, 0x6e,
	...
	,
	...
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x60, 0x0a, 0x1b, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x52, 0x65,
	...
	0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0xa0, 0x01, 0x0a, 0x21, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72,
	0x6b, 0x53, 0x75, 0x62, 0x6e, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1d,
	...
	0x72, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x6f, 0x6f, 0x6c, 0x5f, 0x73, 0x74, 0x61, 0x72, 0x74, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x6f, 0x6f, 0x6c, 0x53, 0x74, 0x61, 0x72, 0x74,
	0x12, 0x19, 0x0a, 0x08, 0x70, 0x6f, 0x6f, 0x6c, 0x5f, 0x65, 0x6e, 0x64, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x07, 0x70, 0x6f, 0x6f, 0x6c, 0x45, 0x6e, 0x64, 0x22, 0xa0, 0x01, 0x0a, 0x21,
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x4e, 0x65, 0x74,
	0x77, 0x6f, 0x72, 0x6b, 0x53, 0x75, 0x62, 0x6e, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x63, 0x69, 0x64, 0x72, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x6f, 0x6f, 0x6c, 0x5f, 0x73, 0x74, 0x61,
	0x72, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x6f, 0x6f, 0x6c, 0x53, 0x74,
	0x61, 0x72, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x6f, 0x6f, 0x6c, 0x5f, 0x65, 0x6e, 0x64, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x6f, 0x6f, 0x6c, 0x45, 0x6e, 0x64, 0x22, 0x52,
	0x0a, 0x21, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x4e,
	...
	,
...
var file_network_proto_msgTypes = make([]protoimpl.MessageInfo, 39)
var file_network_proto_goTypes = []interface{}{
	...
	(*DHCPNetworksRequest)(nil),               // 9: api.network.DHCPNetworksRequest
	(*Cidr)(nil),                              // 10: api.network.Cidr
	(*MacIPMapping)(nil),                      // 11: api.network.MacIPMapping
	(*DHCPNetwork)(nil),                       // 12: api.network.DHCPNetwork
	(*DHCPNetworksResponse)(nil),              // 13: api.network.DHCPNetworksResponse
	(*AdminListSwitchesResponse)(nil),         // 14: api.network.AdminListSwitchesResponse
	(*AdminGetSwitchRequest)(nil),             // 15: api.network.AdminGetSwitchRequest
	(*AdminDeleteSwitchRequest)(nil),          // 16: api.network.AdminDeleteSwitchRequest
	(*AdminCreateSwitchRequest)(nil),          // 17: api.network.AdminCreateSwitchRequest
	(*AdminUpdateSwitchRequest)(nil),          // 18: api.network.AdminUpdateSwitchRequest
	(*ListSwitchesResponse)(nil),              // 19: api.network.ListSwitchesResponse
	(*MacAddressMapping)(nil),                 // 20: api.network.MacAddressMapping
	(*UpdateMacAddressMappingRequest)(nil),    // 21: api.network.UpdateMacAddressMappingRequest
	(*ConfigureSwitchPortRequest)(nil),        // 22: api.network.ConfigureSwitchPortRequest
	(*AdminListNetworksResponse)(nil),         // 23: api.network.AdminListNetworksResponse
	(*AdminCreateNetworkRequest)(nil),         // 24: api.network.AdminCreateNetworkRequest
	(*AdminUpdateNetworkRequest)(nil),         // 25: api.network.AdminUpdateNetworkRequest
	(*AdminCreateSubnetRequest)(nil),          // 26: api.network.AdminCreateSubnetRequest
	(*AdminUpdateSubnetRequest)(nil),          // 27: api.network.AdminUpdateSubnetRequest
	(*AdminDeleteSubnetRequest)(nil),          // 28: api.network.AdminDeleteSubnetRequest
	(*AdminDeleteNetworkRequest)(nil),         // 29: api.network.AdminDeleteNetworkRequest
	(*AdminGetNetworkRequest)(nil),            // 30: api.network.AdminGetNetworkRequest
	(*AdminListVlansRequest)(nil),             // 31: api.network.AdminListVlansRequest
	(*AdminCreateVlanRequest)(nil),            // 32: api.network.AdminCreateVlanRequest
	(*VLAN)(nil),                              // 33: api.network.VLAN
	(*AdminListVlansResponse)(nil),            // 34: api.network.AdminListVlansResponse
	(*AdminDeleteVlanRequest)(nil),            // 35: api.network.AdminDeleteVlanRequest
	(*ListProjectNetworksRequest)(nil),        // 36: api.network.ListProjectNetworksRequest
	(*ListProjectNetworksResponse)(nil),       // 37: api.network.ListProjectNetworksResponse
	(*GetProjectNetworkRequest)(nil),          // 38: api.network.GetProjectNetworkRequest
	(*UpdateProjectNetworkRequest)(nil),       // 39: api.network.UpdateProjectNetworkRequest
	(*CreateProjectNetworkSubnetRequest)(nil), // 40: api.network.CreateProjectNetworkSubnetRequest
	(*UpdateProjectNetworkSubnetRequest)(nil), // 41: api.network.UpdateProjectNetworkSubnetRequest
	(*DeleteProjectNetworkSubnetRequest)(nil), // 42: api.network.DeleteProjectNetworkSubnetRequest
	(*DataCenter)(nil),                        // 43: api.region.DataCenter
	(*timestamppb.Timestamp)(nil),             // 44: google.protobuf.Timestamp
	(*BasicProject)(nil),                      // 45: api.basic.BasicProject
}
var file_network_proto_depIdxs = []int32{
	1,  // 0: api.network.Switch.type:type_name -> api.network.SwitchType
	43, // 1: api.network.Switch.datacenter:type_name -> api.region.DataCenter
	8,  // 2: api.network.Switch.server_interfaces:type_name -> api.network.ServerInterface
	44, // 3: api.network.Switch.created_at:type_name -> google.protobuf.Timestamp
	44, // 4: api.network.Switch.updated_at:type_name -> google.protobuf.Timestamp
	44, // 5: api.network.Switch.last_arp_sync:type_name -> google.protobuf.Timestamp
	0,  // 6: api.network.Network.type:type_name -> api.network.NetworkType
	45, // 7: api.network.Network.project:type_name -> api.basic.BasicProject
	6,  // 8: api.network.Network.subnets:type_name -> api.network.Subnet
	43, // 9: api.network.Network.datacenter:type_name -> api.region.DataCenter
	44, // 10: api.network.Network.created_at:type_name -> google.protobuf.Timestamp
	44, // 11: api.network.Network.updated_at:type_name -> google.protobuf.Timestamp
	5,  // 12: api.network.Subnet.network:type_name -> api.network.Network
	10, // 13: api.network.Subnet.cidr:type_name -> api.network.Cidr
	10, // 14: api.network.Subnet.gateway_ip:type_name -> api.network.Cidr
	10, // 15: api.network.Subnet.pool_start:type_name -> api.network.Cidr
	10, // 16: api.network.Subnet.pool_end:type_name -> api.network.Cidr
	10, // 17: api.network.IPAddress.address:type_name -> api.network.Cidr
	...
	44, // 22: api.network.ServerInterface.created_at:type_name -> google.protobuf.Timestamp
	44, // 23: api.network.ServerInterface.updated_at:type_name -> google.protobuf.Timestamp
	43, // 24: api.network.DHCPNetworksRequest.datacenter:type_name -> api.region.DataCenter
	0,  // 25: api.network.DHCPNetworksRequest.network_type:type_name -> api.network.NetworkType
	3,  // 26: api.network.Cidr.ip_version:type_name -> api.network.Cidr.Version
	10, // 27: api.network.DHCPNetwork.network:type_name -> api.network.Cidr
	6,  // 28: api.network.DHCPNetworksResponse.subnets:type_name -> api.network.Subnet
	11, // 29: api.network.DHCPNetworksResponse.mapping:type_name -> api.network.MacIPMapping
	4,  // 30: api.network.AdminListSwitchesResponse.switches:type_name -> api.network.Switch
	1,  // 31: api.network.AdminCreateSwitchRequest.type:type_name -> api.network.SwitchType
	1,  // 32: api.network.AdminUpdateSwitchRequest.type:type_name -> api.network.SwitchType
	4,  // 33: api.network.ListSwitchesResponse.switches:type_name -> api.network.Switch
	20, // 34: api.network.UpdateMacAddressMappingRequest.mapping:type_name -> api.network.MacAddressMapping
	4,  // 35: api.network.ConfigureSwitchPortRequest.switch:type_name -> api.network.Switch
	5,  // 36: api.network.AdminListNetworksResponse.networks:type_name -> api.network.Network
	0,  // 37: api.network.AdminCreateNetworkRequest.type:type_name -> api.network.NetworkType
	33, // 38: api.network.AdminListVlansResponse.vlans:type_name -> api.network.VLAN
	5,  // 39: api.network.ListProjectNetworksResponse.networks:type_name -> api.network.Network
...
func file_network_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_network_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DHCPNetworksRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_network_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DHCPNetworksResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
